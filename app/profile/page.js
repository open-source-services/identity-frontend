    ...
    const fetchProfile = async () => {
      try {
        ...
        if (
          response.data &&
          response.data.data &&
          response.data.message !== "Get profile endpoint - to be implemented"
        ) {
          ...
          console.log(
            "Backend profile endpoint not implemented, using JWT token data"
          );
        ...
        <div className="flex">
          ...
          <div className="w-80 bg-slate-800 min-h-screen shadow-2xl fixed left-0 top-0 z-10">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-8 h-8 bg-linear-to-r from-emerald-400 to-blue-500 rounded-lg flex items-center justify-center">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-6">
                        <Avatar
                          ...
                          className="bg-linear-to-br from-blue-500 to-purple-600 text-white text-2xl font-bold shadow-xl"
                        />
                ...
                <Card className="bg-white shadow-sm border border-gray-200">
                  ...
                  <CardBody className="p-6">
                    <p className="text-gray-600 mb-6 leading-relaxed">
                      View and manage the email addresses associated with your
                      account. They can be used to sign in and to reset password
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                          ...
                          This will permanently delete your profile, all
                          associated data, and revoke access to all services.
                        </p>
                        <Button
                          color="danger"
                          variant="solid"
          ...
          <Modal isOpen={isOpen} onOpenChange={onOpenChange} backdrop="blur">
            <ModalContent className="border-2 border-red-200">
              {(onClose) => (
                <>
                  <ModalHeader className="flex items-center gap-3 pb-2 bg-linear-to-r from-red-50 to-orange-50 rounded-t-large">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                        <p className="text-sm text-yellow-700 font-medium">
                          💡 This action cannot be undone and data cannot be
                          recovered.
                        </p>
                      </div>
                    </div>
